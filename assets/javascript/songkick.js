...
function search_similar_artist(artist_name){
    var artist_name;

    var queryURL="https://api.songkick.com/api/3.0/artists/"+artist_name+"/similar_artists.json?apikey=4s4kGBz0WjJ4Yk6O";
    $.ajax({
        url: queryURL,
        method: "GET"
      }).then(function(response) {
...
function search_by_metroArea(metroName){
    ...
    var queryURL ="https://api.songkick.com/api/3.0/metro_areas/{metro_area_id}/calendar.json?apikey={your_api_key}"
}

//$(document).ready(function(){
var band_name = "Mariah Carey";
search_by_artist(band_name);

//});

//search_similar_artist(band_name);
